...
import com.tnexam.entity.ResourceActivity;
...
public class ProgressService {
    ...
    private final ResourceActivityRepository resourceActivityRepository;

    public ProgressService(ResultRepository resultRepository,
                           ResourceActivityRepository resourceActivityRepository) {
