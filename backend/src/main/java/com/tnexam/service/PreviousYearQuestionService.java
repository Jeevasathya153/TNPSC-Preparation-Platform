...
import com.tnexam.entity.PreviousYearQuestion;
...
public class PreviousYearQuestionService {
    ...
    private final PreviousYearQuestionRepository previousYearQuestionRepository;

    public PreviousYearQuestionService(PreviousYearQuestionRepository previousYearQuestionRepository) {
        this.previousYearQuestionRepository = previousYearQuestionRepository;
    }
