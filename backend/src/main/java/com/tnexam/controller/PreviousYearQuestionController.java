...
public class PreviousYearQuestionController {
    ...
    public PreviousYearQuestionController(PreviousYearQuestionService previousYearQuestionService) {
        this.previousYearQuestionService = previousYearQuestionService;
    }
